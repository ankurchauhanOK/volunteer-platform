    ...
    return (
      <div className="space-y-1.5">
        ...
        <input
          ...
          id={inputId}
          className={cn(
            "flex h-10 w-full rounded-xl border bg-white px-4 py-2.5 text-sm text-text placeholder:text-text-muted",
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sb-500 focus-visible:ring-offset-0",
            "disabled:cursor-not-allowed disabled:opacity-50",
            error ? "border-error-text focus-visible:ring-red-500" : "border-border focus-visible:border-sb-500",
            className,
          )}
          ref={ref}
          {...props}
