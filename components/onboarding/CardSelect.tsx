        ...
        {options.map(option => (
          ...
          >
            ...
            <span className={cn(
              ...
              isSelected(option.value) ? "text-sb-700" : "text-gray-700",
            )}>
              {option.label}
            </span>
            {option.description && (
            ...
            {isSelected(option.value) && (
                <div className="check-icon absolute top-1.5 right-1.5 w-4 h-4 rounded-full bg-sb-500 flex items-center justify-center">
